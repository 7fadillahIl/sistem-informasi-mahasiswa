                                ...
                                <div class="row">
                                    <div class="col-lg">
                                        ...
                                        <select name="nama_kelas" id="nama_kelas" class="form-control">
                                            ...
                                            <?php $sql_tahun = mysqli_query($koneksi, "SELECT * FROM kelas") or die(mysqli_error($koneksi));
                                            while ($datatahun = mysqli_fetch_assoc($sql_tahun)) {
                                                echo '<option value="' . $datatahun["nama_kelas"] . '">' . $datatahun["nama_kelas"] . '</option>';
                                            }
                                            ?>
                                        </select>
                                    </div>
...
?>
<input type="hidden" name="nama_mhs" value='<?php echo $datamapel["nama_mhs"] ?>'>
<td>
...
<td>
<label for="ekstra">Izin</label>
<input type="number" name="izin" id="izin" class="form-control">
</td>
<td>
<label for="ekstra">Terima kasih atas klarifikasinya. Pada bagian penutup tag, ada beberapa penyesuaian yang perlu dilakukan agar semuanya tertutup dengan benar. Berikut ini adalah penyesuaian pada bagian penutup tag:
